...
class Encoder(nn.Module):
    def __init__(self, ch=3, nz=128, nf=64):
        super().__init__()
        self.main = nn.Sequential(
            ...
            nn.Conv2d(nf*8, nz*2, kernel_size=2, stride=2, padding=0, bias=True),
        )
...
class Decoder(nn.Module):
    def __init__(self, ch=3, nz=128, nf=64):
        ...
        self.main = nn.Sequential(
            ...
            nn.ConvTranspose2d(nf, ch, kernel_size=1, stride=1, padding=0, bias=True),
            nn.Tanh()
        )
